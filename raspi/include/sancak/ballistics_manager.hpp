...
public:
     ...
     */
    BallisticCorrection calculate(float distance_m,
     ...
     */
    float calculateParallax(float distance_m) const;
     ...
     */
    float calculateDrop(float distance_m) const;
     ...
     */
    float calculateLead(float target_speed_mps, float distance_m) const;
